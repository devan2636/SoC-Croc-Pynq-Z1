...
set ltx_file ${project_root}/${proj}.runs/impl_1/croc_xilinx.ltx
if { [file exists $ltx_file] } {
    file copy -force $ltx_file ${xilinx_root}/out/${proj}.${board}.ltx
} else {
    puts "WARNING: No .ltx file was generated for ${proj}.${board}; continuing without it."
}
